...
QuotaCap tracks AI subscription quotas. It shows usage, remaining, and reset times, and advises which one to use next. Dashboard, CLI, and MCP are local surfaces for that, across Claude, Codex, Kimi, and Grok.
