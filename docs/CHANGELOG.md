...
- Sign-in failures: Antigravity's eligibility text and a Codex device-code screen classify as account confirmation. The dashboard tells you to open the CLI, complete the browser sign-in, and select Retry. The browser link stays off the banner and out of the log.
